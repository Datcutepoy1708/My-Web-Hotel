            ...
            <div class="col-md-3 col-lg-2 px-0 sidebar">
                <div class="profile-section">
                    <?php if (!empty($user['avatar'])): ?>
                        <img src="<?= htmlspecialchars($user['avatar']) ?>" alt="Profile Avatar" class="profile-img" />
                    <?php else: ?>
                        <img src="/My-Web-Hotel/client/assets/images/275f99923b080b18e7b474ed6155a17f.jpg" alt="Profile Avatar" class="profile-img" />
                    <?php endif; ?>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="personal" role="tabpanel">
                            <div class="content-card">
                                ...
                                <?php endif; ?>
                                <form method="post" action="../controller/update-profile.php" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-2">
                                                <?php if (!empty($user['avatar'])): ?>
                                                    <img id="avatarPreview" src="<?= htmlspecialchars($user['avatar']) ?>" 
                                                         alt="Avatar" style="width: 120px; height: 120px; object-fit: cover; border-radius: 8px; border: 2px solid #ddd; display: block;">
                                                <?php else: ?>
                                                    <img id="avatarPreview" src="/My-Web-Hotel/client/assets/images/275f99923b080b18e7b474ed6155a17f.jpg" 
                                                         alt="Avatar" style="width: 120px; height: 120px; object-fit: cover; border-radius: 8px; border: 2px solid #ddd; display: block;">
                                                <?php endif; ?>
                                            </div>
                                            <input type="file" class="form-control" name="avatar" id="avatarInput" accept="image/*" onchange="previewAvatar(this)">
