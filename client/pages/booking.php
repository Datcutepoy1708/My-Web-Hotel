            ...
            <div class="form-section">
              ...
              <div class="form-row">
                <div class="form-group">
                  <label for="roomName"
                    >Tên phòng <span class="required">*</span></label
                  >
                  <input
                    type="text"
                    id="roomName"
                ...
                <div class="form-group">
                  <label for="roomType"
                    >Loại phòng <span class="required">*</span></label
                  >
              ...
              <div class="form-row">
                <div class="form-group">
                  <label for="guestCount"
                    >Số người lớn<span class="required">*</span></label
                  >
                  <input
                    type="number"
                    id="guestCount"
                ...
                <div class="form-group">
                  <label for="roomInfo"
                    >Số trẻ em <span class="required">*</span></label
                  >
                  <input
                    type="number"
                    id="childCount"
              ...
              <div class="form-row">
                <div class="form-group">
                  <label for="checkinTime"
                    >Check-in <span class="required">*</span></label
                  >
                  <input
                    type="datetime-local"
                    id="checkinTime"
                ...
                <div class="form-group">
                  <label for="checkoutTime"
                    >Check-out <span class="required">*</span></label
                  >
                  <input
                    type="datetime-local"
                    id="checkoutTime"
            ...
            <div class="form-section">
              ...
              <div class="form-row">
                <div class="form-group full-width">
                  <label for="roomPrice"
                    >Giá phòng (VNĐ) <span class="required">*</span></label
                  >
                  <input
                    type="number"
                    id="roomPrice"
              ...
              <div class="form-row">
                <div class="form-group full-width">
                  <label for="paymentMethod"
                    >Chọn phương thức <span class="required">*</span></label
                  >
            ...
            <div class="form-section">
              ...
              <div class="form-group full-width">
                ...
                <textarea
                  id="notes"
                  name="notes"
                  placeholder="VD: Yêu cầu phòng tầng cao, không hút thuốc..."
                ></textarea>
              </div>
            </div>
        ...
        <div class="invoice-container" id="invoiceContainer">
            ...
            <div class="section">
              ...
              <div class="payment-summary">
                ...
                >
                  <span>Tiền cọc (30%):</span>
                  <span
                    style="color: #deb666; font-weight: 700"
                    id="invoiceDeposit"
                    >-</span
                  >
                </div>
          ...
          <div class="footer">
            ...
            <p style="margin-top: 5px">
              Vui lòng giữ lại hóa đơn này để làm thủ tục nhận phòng
            </p>
          </div>
        </div>
      </div>
