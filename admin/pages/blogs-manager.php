                        ...
                        <div class="content-item">
                            ...
                            <div class="content-details">
                                ...
                                <div class="content-actions">
                                    <button class="btn-sm-custom view" data-bs-toggle="modal" data-bs-target="#viewBlogModal<?php echo $blog['blog_id'];  ?>">
                                    ...
                                    <div class="modal-body" style="max-height: 80vh; overflow-y: auto">
                                        ...
                                        <div id="blogPreviewContent">
                                            ...
                                            <div class="blog-preview-header">
                                                <span class="blog-preview-category" id="previewCategory"><?php echo h($blog['category'] ?: 'Chưa phân loại'); ?></span>
                                                ...
                                                <div class="blog-preview-meta">
                                                    ...
                                                    <span><i class="fas fa-eye"></i>
                                                        <span id="previewViews"><?php echo number_format($blog['view_count']); ?> </span> lượt xem</span>
                                                </div>
                                            </div>
        ...
        <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="status" required>
                                    <option value="Draft" <?php echo ($editBlog['status'] ?? 'Draft') == 'Draft' ? 'selected' : ''; ?>>Bản nháp</option>
                                    <option value="Published" <?php echo ($editBlog['status'] ?? '') == 'Published' ? 'selected' : ''; ?>>Xuất bản ngay</option>
                                    <option value="Archived" <?php echo ($editBlog['status'] ?? '') == 'Archived' ? 'selected' : ''; ?>>Đã lưu trữ</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <?php else: ?>
                                    <img id="blogPreview" class="image-preview mt-3" style="display: none; max-width: 100%; max-height: 200px; border-radius: 5px;" />
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn-primary-custom" name="<?php echo $editBlog ? 'update_blog' : 'add_blog'; ?>">
